...
const NewRecord = (props) => {
  ...
  const [hospitalRecordID, setHospitalRecordID] = useState("");
            ...
            <InputContainer>
              <InputSubContainer>
                ...
                <TextField
                  ...
                  required
                  value={hospitalRecordID}
                  onChange={(e) => setHospitalRecordID(e.target.value)}
                />
          ...
          <HopitalCard>
            ...
            <HospCardDetails>
              ...
              <HospCardAdd>
                ...
                <div>Building 61 I.I Chundrigarh Road, Karachi</div>
              </HospCardAdd>
            </HospCardDetails>
            <HospCardRow3>
              <FCName>ID Card</FCName>
            </HospCardRow3>
          </HopitalCard>
        </center>
      </Right>
